# code works fine and prints reading to UART
...
#set sampling cycles
...
#enable interrupt in ADC contorl register1 
	li x10,R32_ADC_CTLR1
	lw x11,0(x10)
	li x7,(1<<5)			# (1<<5) enable end of conversion interrupt
	or x11,x11,x7
	sw x11,0(x10)	
	...
	li x10,R32_ADC_CTLR2
	lw x11,0(x10)
	li x7,(1<<0)|(7<<17)|(1<<1)	# 7<<17 SWSTART is trigger conversion, 1<<0 ADON , 1<<1 enable continues mode
	or x11,x11,x7
	sw x11,0(x10)
...
# ADC measure , wait for interrupt to trigger and print out values
